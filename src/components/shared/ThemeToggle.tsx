...
export default function ThemeToggle() {
  ...
  // Synchronize the class on the body/wrapper whenever darkMode changes
  useEffect(() => {
    // We target the root layout or a specific wrapper
    ...
    <div className="_layout_mode_swithing_btn">
      ...
      >
        <div className="_layout_swithing_btn">
          {/* Your design logic for the slider movement usually goes here via CSS transitions on _dark_wrapper */}
