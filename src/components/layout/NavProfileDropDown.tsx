...
export default function NavProfileDropDown() {
  ...
  return (
    <div className="_nav_profile_dropdown _profile_dropdown d-block shadow-sm">
      ...
      <hr />
      <ul className="_nav_dropdown_list list-unstyled">
        ...
        <li className="_nav_dropdown_list_item">
          <div onClick={handleLogout} className="_nav_dropdown_link _cursor_pointer">
            <div className="_nav_drop_info">
              <span>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
