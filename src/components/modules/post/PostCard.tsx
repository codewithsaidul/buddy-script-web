      ...
      <div className="_feed_inner_timeline_content _padd_r24 _padd_l24">
        <div className="_feed_inner_timeline_post_top">
          ...
          <div className="_feed_inner_timeline_post_box_dropdown">
            ...
            {/* Dropdown Menu - Visibility toggled by state */}
            <div
              className={`_feed_timeline_dropdown ${
                isDropdownOpen ? "_timeline_dropdown_show" : ""
              }`}
        ...
        <div className="_feed_inner_timeline_total_reacts_image">
          {post.likes.slice(0, 5).map((user, idx) => (
            <Image
              ...
              width={20}
              height={20}
              className={idx === 0 ? "_react_img1" : "_react_img _rect_img_mbl_none"}
            />
          ))}
          <p className="_feed_inner_timeline_total_reacts_para">
            {post.likes.length > 5 ? `${post.likes.length - 5}+` : post.likes.length}
          </p>
        </div>
          ...
          <div className="_comment_main">
            <div className="_comment_image">
              <Link href="/profile" className="_comment_image_link">
                <Image src="/assets/images/txt_img.png" alt="" width={32} height={32} className="_comment_img1" />
              </Link>
            </div>
